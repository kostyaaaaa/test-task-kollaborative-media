import CardLogoImage from 'assets/images/card-logo.jpg';
import LogoBlueImage from 'assets/images/logo-blue.png';
import ProductImage from 'assets/images/product.jpeg';
import { STATES } from 'pages/Checkout/constants';
import { PAYMENT_FORM_INITIAL_VALUES } from 'pages/Checkout/constants';
...
const PaymentView = () => {
  const [formValues, setFormValues] = useState(PAYMENT_FORM_INITIAL_VALUES);
        ...
        <div className="d-flex flex-wrap w-100">
          ...
          <div className="left-side flex-auto order-lg-0">
            ...
            <div className="payment-card-section w-100 d-block">
              ...
              <div className="payment-card-box w-100 d-block">
                <div className="payment-card-box-top w-100 d-flex flex-wrap justify-content-between">
                  ...
                  <span>
                    <Image src={CardLogoImage} className="img-fluid" />
                  </span>
                </div>
            ...
            <div className="btn-row w-100 d-flex justify-content-between">
              ...
              <Button onClick={voidFunction} className="checkout-btn">
                Checkout now
              </Button>
            </div>
